...
title = Label(text='Welcome to Personal Assist',height=5, width=20)

startButton = Button(root, height=5, width=20, text="Start Assistant", command=lambda: start_execution())
stopButton = Button(root, height=5, width=20, text="Close App", command=lambda: stopExecution())
